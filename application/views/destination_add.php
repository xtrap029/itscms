			...
			<div class="box-body">
				<form method="post">
					...
					<div class="form-group <?php echo (form_error('code') == '') ? '' : 'has-error'; ?>">
						...
						<input type="text" class="form-control" name="code" placeholder="Code" value="<?php if(!empty($_POST['code'])) echo $_POST['code'];?>">
				  	</div>
				  	<?php echo form_error('code'); ?>
				  	<div class="form-group <?php echo (form_error('description') == '') ? '' : 'has-error'; ?>">
				  		<label class="text-muted">Description</label>
						<textarea name="description" class="form-control"><?php if(!empty($_POST['description'])) echo $_POST['description'];?></textarea>
					</div>
